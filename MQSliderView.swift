...
class MQSliderView: UIView, UIScrollViewDelegate {
    ...
    /// 间歇高度
    public var spaceHeight: CGFloat = 5
    ...
    private func addContentView() {
        ...
        scrollView.frame = CGRect(x: 0, y: topView.bottom + spaceHeight, width: self.width, height: self.height - topView.height - spaceHeight)
